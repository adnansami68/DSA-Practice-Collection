...
- [ ] [Minimum Number of Operations to Move All Balls](https://leetcode.com/problems/minimum-number-of-operations-to-move-all-balls-to-each-box/description/)
...
- [ ] [Convert an Array Into a 2D Array](https://leetcode.com/problems/convert-an-array-into-a-2d-array-with-conditions/description/)
...
- [ ] [Min Swaps to Make String Balanced](https://leetcode.com/problems/minimum-number-of-swaps-to-make-the-string-balanced/description/)
...
- [ ] [Linked List Cycle (Hash)](https://leetcode.com/problems/linked-list-cycle/description/)
- [ ] [Intersection of Two Linked Lists (Hash)](https://leetcode.com/problems/intersection-of-two-linked-lists/description/)
- [ ] [First Unique Character (Hash)](https://leetcode.com/problems/first-unique-character-in-a-string/description/)
- [ ] [Next Greater Element I (Hash)](https://leetcode.com/problems/next-greater-element-i/description/)
...
- [ ] [Maximum Product of Two Elements](https://leetcode.com/problems/maximum-product-of-two-elements-in-an-array/description/)
- [ ] [Largest Number After Digit Swaps](https://leetcode.com/problems/largest-number-after-digit-swaps-by-parity/description/)
...
#### 10. Tree (Others)
- [ ] [Convert Sorted Array to BST](https://leetcode.com/problems/convert-sorted-array-to-binary-search-tree/description/)
